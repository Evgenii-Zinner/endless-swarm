  ...
  return (
    <main className="w-full h-full relative bg-[#020617]">
      ...
      <button
        ...
        className="absolute top-8 left-8 p-3 -m-3 text-white/70 hover:text-white active:scale-95 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-sky-400 focus-visible:ring-offset-2 focus-visible:ring-offset-[#020617] rounded-lg text-sm font-bold tracking-widest transition-all z-20"
      >
        &#8592; MENU
      </button>
    </main>
